...
fitness = function(vetorPop, vetorValor){
  ...
  #Soma de cada grupo da população
  soma0 = 0
  soma1 = 0
  ...
  #Calcula a diferença entre os dois grupos
  dif <- soma0 - soma1
  if(dif < 0){
...
#Leitura do arquivo
valores <- scan("/Users/RodolfoSaldanha/Desktop/IA/2bim/Lista-1/numeros_particao.txt", numeric())
...
while(geracao < 500){
  ...
  cat("Geração: ", geracao, "Diferença: ", fit, "\n")
